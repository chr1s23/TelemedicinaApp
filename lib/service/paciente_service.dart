...
sealed class PacienteService {
  static Future<bool??> registrarDispositivo(BuildContext context, DispositivoRequest dispositivo, String publicId) async {
    try {
      final response = await getDio().put("/paciente/registrar-dispositivo/$publicId", data: dispositivo.toJson());
