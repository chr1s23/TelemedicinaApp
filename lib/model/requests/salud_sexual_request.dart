class SaludSexualRequest{
    ...
    SaludSexualRequest(this.estaEmbarazada, this.fechaUltimaMenstruacion, this.ultimoExamenPap, this.tiempoPruebaVph, this.numParejasSexuales, this.tieneEts, this.nombreEts, this.enfermedadAutoinmune, this.nombreAutoinmune);
